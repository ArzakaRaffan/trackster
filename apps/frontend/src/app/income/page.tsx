    ...
    <div className="pb-navbar animate-fade-in-up">
      ...
      <div className="flex flex-col gap-4 px-4">
        <section className="rounded-medium bg-surface p-5">
          ...
          <p className="font-title text-amount font-extrabold tabular-nums text-status-under">{formatRupiah(total)}</p>
        </section>
                  ...
                  <span className="mt-0.75 flex items-center gap-2">
                    <span
                      className={`rounded-subtle px-1.5 py-0.5 text-micro font-bold uppercase tracking-caps ${
                        SOURCE_STYLE[income.source] || 'bg-track text-ink-muted'
                      }`}
                    >
